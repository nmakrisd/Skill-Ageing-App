...
mean_hazard = skill_lifespan["hazard"].mean()
median_hazard = skill_lifespan["hazard"].median()
print(f"\nMean hazard value across all skills: {mean_hazard:.4f}")
print(f"Median hazard value across all skills: {median_hazard:.4f}")
...
plt.legend()
plt.tight_layout()
plt.savefig("skill_hazard_overlay_diagnostics.png")
plt.show()
